const FIXED_MICRO_META = {
  ...
  vitamin_e: { name: '维生素E', preferredUnit: 'mg', legacyUnit: 'mg' },
  ...
  phosphorus: { name: '磷', preferredUnit: 'mg', legacyUnit: 'mg' },
  zinc: { name: '锌', preferredUnit: 'mg', legacyUnit: 'mg' },
  taurine: { name: '牛磺酸', preferredUnit: 'mg', legacyUnit: 'mg' },
